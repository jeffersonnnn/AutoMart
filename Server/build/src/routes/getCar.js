...
router.get('/car/:carId/', _verifyAuthToken["default"], _AdValidate["default"].validateCarId, _carController["default"].getCarById);
router.get('/car', _carController["default"].getAvailableCars);
var _default = router;
