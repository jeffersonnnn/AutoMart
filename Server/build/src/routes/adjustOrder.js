...
router.patch('/order/:orderId/price', _verifyAuthToken["default"], _AdValidate["default"].adjustOrder, _AdValidate["default"].validateOrderId, _carController["default"].adjustOrder);
var _default = router;
