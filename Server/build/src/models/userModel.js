  ...
  _createClass(User, null, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                params = [email];
                _context.next = 4;
                return (0, _dbQuery["default"])(sql, params);
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee2(user) {
        var password, email, firstName, lastName, address, sql, params, query;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                password = _password["default"].hashPassword(user.password);
                email = user.email, firstName = user.firstName, lastName = user.lastName, address = user.address;
                sql = "INSERT INTO users (firstname, lastname, email, address, password) VALUES($1, $2, $3, $4, $5) RETURNING *";
                params = [firstName, lastName, email, address, password];
                _context2.next = 6;
                return (0, _dbQuery["default"])(sql, params);
